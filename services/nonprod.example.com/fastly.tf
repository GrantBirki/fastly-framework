...
resource "fastly_service_v1" "fastly-service" {
  ...
  */
  ...
  name = "nonprod.example.com" #ID0001
  ...
  */
  ...
  domain {
    name    = "${var.FastlyEnv}nonprod.example.com"
    comment = "Example domain"
  }

  domain {
    name    = "${var.FastlyEnv}nonprod-app.example.com"
  ...
  */
  ...
  backend {
    address                  = "nonprod.backend.webservice.example.com"
    name                     = "nonprod_backend_webservice_example_com_443"
    ssl_cert_hostname        = "nonprod.backend.webservice.example.com"
  ...
  backend {
    address                 = "nonprod.backend.appservice.example.com"
    name                    = "nonprod_backend_appservice_example_com_443"
    ssl_cert_hostname       = "nonprod.backend.appservice.example.com"
    port                    = var.OriginDefaults.port
    connect_timeout         = var.OriginDefaults.connect_timeout
    use_ssl                 = var.OriginDefaults.use_ssl
    min_tls_version         = var.OriginDefaults.min_tls_version
  ...
  [nonprod_backend_appservice_example_com_443] backend block above. In order to use
